<html>
	...
	<body>
	<div class="links">
	<?=anchor('admin/users/unactivated_users', 'Unactived Users ')?>
	<?=anchor('admin/users/roles', 'Roles ')?>
	<?=anchor('admin/users/uri_permissions', 'URI Permissions ')?>
	<?=anchor('admin/users/custom_permissions', 'Custom Permissions ')?>
	</div>
	<?php  				
