...
<!--Logo Section-->
				...
				?>
<!--Contact Content-->
				<p class="privacy">To contact <span class="privacy">Unravel</span> for any reason, simply rewrite the following into your favorite email application:</p>
						<?php
				$logo = array(
				...
				echo(img($logo));?><p class="contact">Contact<?=img($at)?><span class="contact">Unravel</span>TheMusic.com</p>
				</div>
		</div>
	</div>
