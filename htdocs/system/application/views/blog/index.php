			...
			?>
				<div class="blogPostHeader">
					<div class="blogPostTitle">
						<h1><?=anchor('blog/view/' . $row->seo_title, $row->title, array('class' => 'blogHeader'))?></h1>
					</div>
					<?php
						$date = $row->created_on;
				...
				?>
					...
					<span class="blogLinksRight">
						...
						?>
						<?=anchor('blog/view/' . $row->seo_title, img($readMore) . ' Read More', array('class' => 'blogLink'))?> | <?=anchor('blog/view/' . $row->seo_title . '#comments', img($comments) . ' Comments', array('class' => 'blogLink'))?>
					</span>
				</div>
			<br /><br />
			<?php
