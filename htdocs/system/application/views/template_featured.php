...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		{
			echo('<script src="http://www.unravelthemusic.com/assets/js/public/unravel-00000009.min.js" type="text/javascript"></script>');
		} else {
			echo('<script src="http://www.unravelthemusic.com/assets/js/public/noUser-00000003.min.js" type="text/javascript"></script>');
		}
		?>
		
		<?=link_tag($url . 'style-00000024.css')?>
		<!--[if lt IE 8]>
