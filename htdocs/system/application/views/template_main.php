...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		{
			echo('<script src="http://www.unravelthemusic.com/assets/js/public/unravel-00000011.min.js" type="text/javascript"></script>');
		} else {
			echo('<script src="http://www.unravelthemusic.com/assets/js/public/noUser-00000006.min.js" type="text/javascript"></script>');
		}
		?>
		
		<?=link_tag($url . 'style-00000034.css')?>
		<!--[if lt IE 8]>
	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="right">
				...
				?>
				<div id="rightSearch">
					<?=anchor('/search/artists', '<h2>Search Unravel</h2>')?>
					<hr class="rightHr" />
